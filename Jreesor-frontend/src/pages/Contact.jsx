...
export const Contact = () => {
  ...
  {/* Left Side */}
  <div className="flex flex-col relative w-full lg:w-1/2 mb-16 lg:mb-0 space-y-6">
    <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif leading-tight tracking-tight">
      <span className="inline-flex items-center space-x-2">
        <FaTruck className="text-white absolute left-[50%] top-[28%]  text-2xl md:text-3xl" />
        <span>We like to hear <br /> from you.</span>
      </span>
    </h1>
    ...
    <Link to="/view" className="inline-flex items-center text-sm uppercase font-garamond tracking-wide mt-2 hover:underline">
      VIEW
